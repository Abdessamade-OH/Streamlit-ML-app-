...
def init_session():
    if "page" not in st.session_state:
        ...
        st.session_state.button_clicked = {"Get Started": False, "Suivant": False, "Précédent": False}
...
def landing_page():
    ...
    if st.button("Get Started"):
        st.session_state.button_clicked["Get Started"] = True

    if st.session_state.button_clicked["Get Started"]:
        st.session_state.page = 1  # Utiliser 1 comme numéro pour la page d'importation
...
def importation_page():
    ...
    st.session_state.button_clicked["Suivant"] = st.button("Suivant")
    if st.session_state.button_clicked["Suivant"]:
        st.session_state.page = 2  # Utiliser 2 comme numéro pour la page de nettoyage
...
def nettoyage_page():
    ...
    st.session_state.button_clicked["Précédent"] = st.button("Précédent")
    st.session_state.button_clicked["Suivant"] = st.button("Suivant")
    if st.session_state.button_clicked["Précédent"]:
        st.session_state.page = 1  # Revenir à la page d'importation
    elif st.session_state.button_clicked["Suivant"]:
        st.session_state.page = 3  # Utiliser 3 comme numéro pour la page de visualisation
...
def visualisation_page():
    ...
    st.session_state.button_clicked["Précédent"] = st.button("Précédent")
    if st.session_state.button_clicked["Précédent"]:
        st.session_state.page = 2  # Revenir à la page de nettoyage
